...
var $author$project$Main$Generic = function (a) {
	return {$: 'Generic', a: a};
};
var $author$project$Route$Generic = function (a) {
	return {$: 'Generic', a: a};
};
var $author$project$Main$GotGenericMsg = function (a) {
	return {$: 'GotGenericMsg', a: a};
};
...
var $author$project$Route$Product = function (a) {
	return {$: 'Product', a: a};
};
var $author$project$Route$ProductList = function (a) {
	return {$: 'ProductList', a: a};
};
var $author$project$Page$Generic$init = function (session) {
	return _Utils_Tuple2(
		{content: 'Generic page goes here', session: session},
		$elm$core$Platform$Cmd$none);
};
	...
	return _Utils_Tuple2(
		{
			images: _List_fromArray(
				[
					{caption: '', src: 'front1.jpg'},
					{caption: '', src: 'front2.jpg'},
					{caption: '', src: 'front3.jpg'},
					{caption: '', src: 'front4.jpg'}
				]),
...
var $author$project$Page$Editable$toSession = function (model) {
	return model.session;
};
var $author$project$Page$Generic$toSession = function (model) {
	return model.session;
};
...
var $author$project$Main$toSession = function (page) {
	switch (page.$) {
		...
		case 'Home':
			var model = page.a;
			return $author$project$Page$Home$toSession(model);
		case 'Generic':
			var model = page.a;
			return $author$project$Page$Generic$toSession(model);
		case 'Editable':
			var model = page.a;
			return $author$project$Page$Editable$toSession(model);
		default:
			return _Debug_todo(
				'Main',
				{
		...
		if (maybeRoute.$ === 'Nothing') {
			...
			switch (maybeRoute.a.$) {
				...
				case 'Contact':
					...
					return A4(
						$author$project$Main$updateWith,
						$author$project$Main$Generic,
						$author$project$Main$GotGenericMsg,
						model,
						$author$project$Page$Generic$init(session));
				case 'Generic':
					var page = maybeRoute.a.a;
					return _Utils_Tuple2(
						model,
						A2(
							$author$project$Route$replaceUrl,
							$author$project$Session$navKey(session),
							$author$project$Route$Generic(page)));
				case 'ProductList':
					var category = maybeRoute.a.a;
					return _Utils_Tuple2(
						model,
						A2(
							$author$project$Route$replaceUrl,
							$author$project$Session$navKey(session),
							$author$project$Route$ProductList(category)));
				default:
					...
					return _Utils_Tuple2(
						...
						A2(
							$author$project$Route$replaceUrl,
							$author$project$Session$navKey(session),
							$author$project$Route$Product(id)));
			}
		}
	});
...
var $author$project$Route$parser = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Route$ProductList,
			A2(
				$elm$url$Url$Parser$slash,
				$elm$url$Url$Parser$s('productList'),
				$elm$url$Url$Parser$string))
		]));
...
var $author$project$Views$Page$NotImplemented = {$: 'NotImplemented'};
...
var $author$project$Page$Blank$view = {
	content: _List_fromArray(
		[
			$mdgriffith$elm_ui$Element$text('asd')
		]),
	title: 'blank'
};
...
var $author$project$Page$Home$img = function (i) {
	return A2(
		...
		_List_Nil,
		{
			label: A2(
				...
				_List_Nil,
				{description: i.caption, src: 'assets/thumb.' + i.src}),
			url: '/assets/' + i.src
		});
};
	...
	return {
		content: _List_fromArray(
			[
				...
				_List_Nil,
				_Utils_ap(
					A2($elm$core$List$map, $author$project$Page$Home$img, model.images),
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text(model.post)
						])))
			]),
		title: 'Hjem'
	};
...
var $author$project$Route$href = F3(
	function (targetRoute, style, label) {
		return A2(
			$mdgriffith$elm_ui$Element$link,
			style,
			{
				label: label,
				url: $author$project$Route$routeToString(targetRoute)
			});
	});
var $author$project$Stylesheet$Black = {$: 'Black'};
var $author$project$Stylesheet$BrickRed = {$: 'BrickRed'};
var $author$project$Stylesheet$Tan = {$: 'Tan'};
...
var $author$project$Stylesheet$color = function (colorScheme) {
	switch (colorScheme.$) {
		case 'Tan':
			return A3($mdgriffith$elm_ui$Element$rgb255, 240, 0, 245);
		case 'Black':
			return A3($mdgriffith$elm_ui$Element$rgb255, 24, 21, 21);
		case 'Sienna':
			return A3($mdgriffith$elm_ui$Element$rgb255, 146, 73, 51);
		case 'DarkOliveGreen':
			return A3($mdgriffith$elm_ui$Element$rgb255, 77, 48, 39);
		default:
			return A3($mdgriffith$elm_ui$Element$rgb255, 193, 49, 53);
	}
};
...
var $author$project$Views$Navigation$navLinkStyle = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$Font$size(16),
		$mdgriffith$elm_ui$Element$Font$family(
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Font$typeface('OpenSans'),
				$mdgriffith$elm_ui$Element$Font$sansSerif
			])),
		$mdgriffith$elm_ui$Element$Font$shadow(
		{
			blur: 5,
			color: $author$project$Stylesheet$color($author$project$Stylesheet$Black),
			offset: _Utils_Tuple2(5, 5)
		}),
		$mdgriffith$elm_ui$Element$Font$color(
		$author$project$Stylesheet$color($author$project$Stylesheet$Black)),
		$mdgriffith$elm_ui$Element$Border$widthEach(
		{bottom: 1, left: 0, right: 0, top: 0}),
		$mdgriffith$elm_ui$Element$Border$color(
		$author$project$Stylesheet$color($author$project$Stylesheet$BrickRed)),
		A2($mdgriffith$elm_ui$Element$paddingXY, 6, 12),
		$mdgriffith$elm_ui$Element$mouseOver(
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Background$color(
				$author$project$Stylesheet$color($author$project$Stylesheet$Tan))
			]))
	]);
var $author$project$Views$Navigation$navLink = F2(
	function (route, label) {
		return A3(
			$author$project$Route$href,
			route,
			$author$project$Views$Navigation$navLinkStyle,
			$mdgriffith$elm_ui$Element$text(label));
	});
var $author$project$Views$Navigation$navigation = A2(
	$mdgriffith$elm_ui$Element$row,
	_List_fromArray(
		[$mdgriffith$elm_ui$Element$Region$navigation]),
	_List_fromArray(
		[
			A2($author$project$Views$Navigation$navLink, $author$project$Route$Home, 'Hjem'),
			A2($author$project$Views$Navigation$navLink, $author$project$Route$Home, 'Saueskinn'),
			A2($author$project$Views$Navigation$navLink, $author$project$Route$Home, 'Skinnprodukter'),
			A2($author$project$Views$Navigation$navLink, $author$project$Route$Home, 'Ull til toving'),
			A2($author$project$Views$Navigation$navLink, $author$project$Route$Home, 'Alpakkagarn'),
			A2($author$project$Views$Navigation$navLink, $author$project$Route$Home, 'Ullgarn'),
			A2($author$project$Views$Navigation$navLink, $author$project$Route$Home, 'Ullundertøy'),
			A2($author$project$Views$Navigation$navLink, $author$project$Route$Home, 'Kurs'),
			A2(
			$author$project$Views$Navigation$navLink,
			$author$project$Route$ProductList('skinn'),
			'Skinn'),
			A2(
			$author$project$Views$Navigation$navLink,
			$author$project$Route$Generic('kontakt'),
			'Kontakt')
		]));
var $author$project$Views$Page$view = F3(
	function (maybeViewer, page, _v0) {
		var title = _v0.title;
		var content = _v0.content;
		var siteNav = $author$project$Views$Navigation$navigation;
		var siteHeader = A2(
			$mdgriffith$elm_ui$Element$image,
			_List_Nil,
			{description: 'Go og varm', src: 'assets/logo.svg'});
		var siteFooter = $mdgriffith$elm_ui$Element$text('Footer');
		return {
...
var $author$project$Main$view = function (model) {
	var viewPage = F3(
		function (page, toMsg, config) {
			var _v6 = A3(
				$author$project$Views$Page$view,
	...
	switch (model.$) {
		case 'Redirect':
			return A3(
				viewPage,
				$author$project$Views$Page$NotImplemented,
				function (_v1) {
...
_Platform_export({'Main':{'init':$author$project$Main$main($elm$json$Json$Decode$value)({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"LinkClicked":["Browser.UrlRequest"],"UrlChanged":["Url.Url"],"Ignored":[],"GotHomeMsg":["Page.Home.Msg"],"GotGenericMsg":["Page.Generic.Msg"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Page.Generic.Msg":{"args":[],"tags":{"NoMsg":[]}},"Page.Home.Msg":{"args":[],"tags":{"HomeImageChange":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}}}}})}});}(this));